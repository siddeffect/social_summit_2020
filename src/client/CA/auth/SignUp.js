      ...
      <div className="container">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
            ...
            <input type="text" id="college" onChange={this.handleChange} />
          </div>
          <div className="input-field">
          ...
          <div className="input-field">
            ...
            <input type="text" id="year_branch" onChange={this.handleChange} />
          </div>
          <div className="input-field">
            <button className="btn pink loghten-1 z-depth-0">Sign up</button>
